;;; org-visual.el --- Org mode visual enhancements -*- lexical-binding: t -*-

;;; Commentary:
;; This module contains visual enhancements for Org mode:
;; - Font faces and heading sizes
;; - Org superstar for headline bullets
;; - Visual fill column for centered text
;; - Inline image settings
;; - Helper functions for emphasis markers

;;; Code:

;; =============================================================================
;; Org Mode Visual Setup Function
;; =============================================================================

;; Configure org mode to start with modes that are more visually appealing
;; - visual-line-mode: wraps lines at window width for easy reading and editing
;; - variable-pitch-mode: sets the font face to a variable-width font for a more natural look
...
;; Enable company-mode (autocomplete) when editing Org files
(add-hook 'org-mode-hook #'company-mode)

;; Display inline images at their natural size (actual pixel width)
...
;; =============================================================================
;; Helper Functions for Fixed-Pitch Faces
;; =============================================================================

(defun my/org-fixed-pitch-faces ()
  "Set specific org faces to use fixed-pitch font."
  (require 'org-indent)
  (dolist (face '(org-block org-table org-formula org-code org-indent
                  org-verbatim org-special-keyword org-meta-line org-checkbox))
...
;; Bind the functions to key combinations in evil visual state
